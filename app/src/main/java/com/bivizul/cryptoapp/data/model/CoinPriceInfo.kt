...
data class CoinPriceInfo(
    ...
    @SerializedName("LASTVOLUMEID")
    @Expose
    val lastVolumeId: String?,
    ...
    @Expose
    val lowHour: String?,
    @SerializedName("TORTIERVOLUME24HOUR")
    @Expose
    val torTierVolume24Hour: String?,
    @SerializedName("TORTIERVOLUME24HOURTO")
    @Expose
    val torTierVolume24HourTo: String?,
